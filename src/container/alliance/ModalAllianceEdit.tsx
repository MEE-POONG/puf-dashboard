...
const ModalAllianceAdd: React.FC = () => {
                    ...
                    <div className="bg-white rounded-lg shadow-lg relative p-6 m-4 max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="card m-5">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <button type="button" onClick={() => setShowModal(false)} className="ml-4 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Cancel</button>
                            </form>
                        </div>
                    </div>
                </div>
